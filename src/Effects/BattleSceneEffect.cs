...
{
    // for loading screen
    private static PictureBox leftPlayerLoadingImage;
    private static PictureBox rightPlayerLoadingImage;
    private static Label leftPlayerName;
    private static Label rightPlayerName;
    
    // public static async Task LoadingBegin(Form source, IPlayer leftPlayer, IPlayer rightPlayer, int duration, int step)
    // {
    //     leftPlayerLoadingImage = new PictureBox
    //     {
    ...
    //     };
    //
    //     rightPlayerLoadingImage = new PictureBox
    //     {
    //         Size = new Size(640, 720),
